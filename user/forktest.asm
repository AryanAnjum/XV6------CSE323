...
forktest(void)
{
  ...
  36:	3ee50513          	addi	a0,a0,1006 # 420 <freemem+0xe>
  ...
  58:	41c50513          	addi	a0,a0,1052 # 470 <freemem+0x5e>
  ...
  6e:	3c650513          	addi	a0,a0,966 # 430 <freemem+0x1e>
  ...
  80:	3cc50513          	addi	a0,a0,972 # 448 <freemem+0x36>
  ...
  b0:	3b450513          	addi	a0,a0,948 # 460 <freemem+0x4e>
